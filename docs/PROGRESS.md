...
| `npm test` clean | Unit, parser, export, and golden suites pass | `tests/` |
...
| 40 graded gallery examples | Done: 41 | `examples/`, `docs/renders/gallery/`, `docs/QUALITY_LOG.md` |
...
| Area | Status |
| --- | --- |
| Core scene graph, timeline, easing, animations | Done |
